...
<link href="asset/front/css/main.min.css" rel="stylesheet">
</head>
<body>
...
<img src="img/header/h_bg_01.svg" alt="img-bg">
</div>
...
<li><a class="dropdown-item" href="index.html">homepage 01<span class="nav-new-tag">new</span></a></li>
<li><a class="dropdown-item" href="v2/index.html">homepage 02<span class="nav-soon-tag">new</span></a></li>
<li><a class="dropdown-item" href="https://coodiv.net/whmcs/index.php?systpl=bredh-standard">WHMCS version</a></li>
</ul>
</li>
<li class="nav-item">
...
<a class="nav-link" role="button" id="webhosting-megamenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">Hosting <span class="megamenu-toggle"></span></a>
<div class="dropdown-menu coodiv-dropdown-megamnu" aria-labelledby="webhosting-megamenu">
<div class="row justify-content-end">
<div class="col-md-6 mega-menu-hosting-container">
<h5 class="mega-menu-hosting-title">you need the best web hosting ?</h5>
<div class="row">
<div class="col-md-6 mega-menu-hosting-content">
<h5><i class="fas fa-server"></i> SHARED HOSTING</h5>
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem, veritatis nulla eum laudantium.</p>
<a href="hosting.html"><i class="fas fa-arrow-circle-right"></i></a>
</div>
<div class="col-md-6 mega-menu-hosting-content">
<h5><i class="fas fa-cloud"></i> DEDICATED HOSTING</h5>
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem, veritatis nulla eum laudantium.</p>
<a href="dedicated.html"><i class="fas fa-arrow-circle-right"></i></a>
</div>
</div>
</div>
</div>
...
<li class="dropdown"><a role="button" id="header-login-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">sign in</a> <span>12365-8448</span>

<div class="dropdown-menu coodiv-dropdown-header user-login-dropdown" aria-labelledby="header-login-dropdown">
<form class="user-login-dropdown-form" action="https://coodiv.net/project/bredh/HTML/signin.html" data-form="validate">
...
<form action="https://coodiv.net/project/bredh/HTML/domains.html" id="domain-search-header" class="col-md-6">
...
<div class="domain-img"><img src="img/domain/black/com.png" alt="" /></div>
<span class="price">$2.99</span>
<span class="features-domains">
<a data-toggle="tooltip" data-placement="right" title="on sale"><img src="img/svgs/Time.svg" alt="" /></a>
<a data-toggle="tooltip" data-placement="right" title="secure"><img src="img/svgs/Locked.svg" alt="" /></a>
</span>
</div>
<div class="domain-name-classes item">
<div class="domain-img"><img src="img/domain/black/net.png" alt="" /></div>
<span class="price">$2.99</span>
<span class="features-domains">
<a data-toggle="tooltip" data-placement="right" title="on sale"><img src="img/svgs/Time.svg" alt="" /></a>
<a data-toggle="tooltip" data-placement="right" title="secure"><img src="img/svgs/Locked.svg" alt="" /></a>
...
<div class="domain-name-classes item">
<div class="domain-img"><img src="img/domain/black/org.png" alt="" /></div>
<span class="price">$2.99</span>
<span class="features-domains">
<a data-toggle="tooltip" data-placement="right" title="on sale"><img src="img/svgs/Time.svg" alt="" /></a>
<a data-toggle="tooltip" data-placement="right" title="secure"><img src="img/svgs/Locked.svg" alt="" /></a>
...
<div class="domain-name-classes item">
<div class="domain-img"><img src="img/domain/black/store.png" alt="" /></div>
<span class="price">$2.99</span>
<span class="features-domains">
<a data-toggle="tooltip" data-placement="right" title="on sale"><img src="img/svgs/Time.svg" alt="" /></a>
<a data-toggle="tooltip" data-placement="right" title="secure"><img src="img/svgs/Locked.svg" alt="" /></a>
...
<div class="container">
<h5 class="title-default-coodiv-two">start your web site now with coodiv <span>simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</span></h5>
<div class="row justify-content-start">
<div class="col-md-4">
<div class="icon-hom-page-service-holder"><img src="img/svgs/Detailed/Battery.svg" alt="" /></div>
<h5 class="icon-hom-page-service-title">web hosting</h5>
<p class="icon-hom-page-service-text">Simply Dummy Text Of The Printing And Typesetting Industry. Lorem Ipsum Has Been The Industry's </p>
</div>
<div class="col-md-4">
<div class="icon-hom-page-service-holder"><img src="img/svgs/Detailed/Download.svg" alt="" /></div>
<h5 class="icon-hom-page-service-title">rasslear hosting</h5>
<p class="icon-hom-page-service-text">Simply Dummy Text Of The Printing And Typesetting Industry. Lorem Ipsum Has Been The Industry's </p>
</div>
<div class="col-md-4">
<div class="icon-hom-page-service-holder"><img src="img/svgs/Detailed/VR.svg" alt="" /></div>
<h5 class="icon-hom-page-service-title">domains</h5>
<p class="icon-hom-page-service-text">Simply Dummy Text Of The Printing And Typesetting Industry. Lorem Ipsum Has Been The Industry's </p>
</div>
<div class="col-md-4">
<div class="icon-hom-page-service-holder"><img src="img/svgs/Detailed/Charger.svg" alt="" /></div>
<h5 class="icon-hom-page-service-title">web hosting</h5>
<p class="icon-hom-page-service-text">Simply Dummy Text Of The Printing And Typesetting Industry. Lorem Ipsum Has Been The Industry's </p>
</div>
<div class="col-md-8 mr-tp-60 hom-page-service-more">
<span class="hom-page-service-more-banner"><img src="img/bg/cercle.png" alt="" /></span>
<h5 class="hom-page-service-more-title">check out our latest offers <span>Simply Dummy Text Of The Printing And Typesetting Industry</span></h5>
<form action="http://hackinout.us15.list-manage.com/subscribe/post-json?u=e44c1f194bec93e238615469e&amp;id=fa63cb4ac7&amp;c=?" method="get" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate hom-page-service-more-form">
<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="entree your email here" required>
...
<a data-toggle="tooltip" data-placement="top" title="accepting visa" href="#"><img src="img/payment/icon-visa.png" alt="" /></a>
<a data-toggle="tooltip" data-placement="top" title="accepting maestro" href="#"><img src="img/payment/icon-maestro.png" alt="" /></a>
<a data-toggle="tooltip" data-placement="top" title="accepting bitcoin" href="#"><img src="img/payment/icon-bitcoin.png" alt="" /></a>
</div>
...
<section class="perlex-efect-section parallax-window padding-100-0 position-relative" data-parallax="scroll" data-image-src="img/demo/office.jpg">

<h6 class="d-none">video section</h6>
<span class="perlex-hidden-iverlow"></span>
<a class="play-button-in-section video-btn" data-toggle="modal" data-src="https://player.vimeo.com/video/58385453?badge=0" data-target="#videomodal" href="#">
...
<a href="#">
<span>email us :</span>
<b><span class="__cf_email__" data-cfemail="50232520203f222410333f3f3439267e3e3524">[email&#160;protected]</span></b>
<i class="fas fa-at"></i>
</a>
<a href="#">
<span>call us :</span>
...
<script src="asset/front/js/template-scripts.js"></script>
...
<script src="asset/front/js/mailchamp.js"></script>

<script src="asset/front/js/bootstrap.offcanvas.min.js"></script>
